...
class WikiSearchScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _wikiSearchController = Get.find<WikiSearchController>();
    Get.put(WikiSearchController());
                    ...
                    Container(
                      ...
                      child: SearchWikiInput(
                        ...
                        textEditingController:
                            _wikiSearchController.searchController,
                        context: context,
                        onValueChanged: (newValue) {
                          _controller.clearList();
                        },
                        onSearchLeadResponse: (searchLead, strLead) {},
                      ),
                    ),
                    Expanded(
                        child: Container(
                                  ...
                                  return Row(
                                    children: [
                                      Container(
                                        ...
                                        height: 50,
                                        child: Image.network(
                                          _controller.mySearchResult[index]
                                                  .thumbnail?.source ??
